 ...
 * @author informatica
 */
@WebServlet(name = "VisualizarFotoServlet", urlPatterns = {"/VisualizarFotoServlet"})
public class VisualizarFotoServlet extends HttpServlet {
